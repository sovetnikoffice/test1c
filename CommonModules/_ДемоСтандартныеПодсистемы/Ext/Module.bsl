...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей) Экспорт
	...
	ЗаполнитьПрофильНастройкаСинхронизацииДанных(ОписанияПрофилей);
...
Функция СведенияОбОрганизации(Организация) Экспорт
	...
	ОсновныеСведения.Вставить("Название", ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Организация, "Представление"));
	
	КонтактнаяИнформация = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(Организация);
	
	ТекстЗапроса =
	"ВЫБРАТЬ
	|	_ДемоОтветственныеЛица.ФизическоеЛицо.Наименование КАК ОтветственноеЛицо
	|ИЗ
	...
	ОтветственныеЛица = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("ОтветственноеЛицо");
	
	Результат = Новый Структура;
	Результат.Вставить("ОсновныеСведения", ОсновныеСведения);
	Результат.Вставить("КонтактнаяИнформация", КонтактнаяИнформация);
	Результат.Вставить("ОтветственныеЛица", ОтветственныеЛица);
...
Процедура ЗаполнитьПрофильОтветственныйЗаНормативноСправочнуюИнформацию(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Ответственный за нормативно-справочную информацию (дополнительно)'");
	ОписаниеПрофиля.Описание =
...
Процедура ЗаполнитьПрофильОтветственныйЗаВедениеВзаимодействий(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Ответственный за ведение взаимодействий (дополнительно)'");
	ОписаниеПрофиля.Описание =
...
Процедура ЗаполнитьПрофильОтветственныйЗаСписокПользователей(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Ответственный за список пользователей (дополнительно)'");
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Дополнительно назначается тем пользователям, которым должна быть
		           |доступна возможность добавления и изменения свойств пользователей
...
Процедура ЗаполнитьПрофильОтветственныйЗаСписокВнешнихПользователей(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Дополнительно назначается тем пользователям, которым должна быть
		           |доступна возможность добавления и изменения свойств внешних пользователей
		           |(подсистема ""Пользователи"").'");
...
Процедура ЗаполнитьПрофильНастройкаСинхронизацииДанных(Знач ОписанияПрофилей)
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "_ДемоНастройкаСинхронизацииДанных";
	...
	// Виды ограничения доступа профиля.
	ОписаниеПрофиля.ВидыДоступа.Добавить("_ДемоМестаХранения",      "Предустановленный");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Организации",             "Предустановленный");
	ОписаниеПрофиля.ВидыДоступа.Добавить("_ДемоГруппыПартнеров",    "Предустановленный");
	ОписаниеПрофиля.ВидыДоступа.Добавить("_ДемоГруппыНоменклатуры", "Предустановленный");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Пользователи",            "Предустановленный");
...
Процедура ЗаполнитьПрофильРедактированиеСогласийНаОбработкуПерсональныхДанных(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Редактирование согласий на обработку персональных данных (дополнительно)'");
	ОписаниеПрофиля.Описание = НСтр("ru = 'Добавление и изменение согласий на обработку персональных данных.'");
...
Процедура ЗаполнитьПрофильПросмотрСогласийНаОбработкуПерсональныхДанных(Знач ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Просмотр согласий на обработку персональных данных (дополнительно)'");
