...
Процедура ВывестиЭлементыНастройки(Форма, Элементы, СвойстваНастройки, ГруппаВывода, Прочее) Экспорт
	...
	Если СвойстваНастройки.ТипЭлементов <> "" Тогда
		...
		ИначеЕсли СвойстваНастройки.ТипЭлементов = "СтандартныйПериод" Тогда
			...
			ВидПериодаИмя           = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИмениЭлемента, "Вид");
			ПредставлениеИмя        = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИмениЭлемента, "Представление");
			...
			СтраницыИмя             = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИмениЭлемента, "Страницы");
			СтраницаСтандартныйИмя  = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИмениЭлемента, "СтраницаСтандартный");
			СтраницаПроизвольныйИмя = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИмениЭлемента, "СтраницаПроизвольный");
			...
			Период.Ширина    = 22;
			Период.РастягиватьПоГоризонтали = Ложь;
...
Процедура УстановитьФиксированныеОтборы(СтруктураОтборов, КомпоновщикНастроек, НастройкиОтчета) Экспорт
	ПараметрыКД = КомпоновщикНастроек.Настройки.ПараметрыДанных;
	ОтборыКД = КомпоновщикНастроек.Настройки.Отбор;
