...
// Процедура - Возможность доопределить сформированную подсказку для формы документа.
//
// Параметры:
...
Процедура ДополнитьПараметрыЗапускаФоновогоЗадания(ДополнительныеПараметрыЗапуска, Форма) Экспорт
	...
	Если Форма.РеквизитыПроверкиКонтрагентов.Свойство("ЮридическоеФизическоеЛицо") Тогда
		ДополнительныеПараметрыЗапуска.Вставить("ЮридическоеФизическоеЛицо", Форма.РеквизитыПроверкиКонтрагентов.ЮридическоеФизическоеЛицо);
	КонецЕсли;
