...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстЗапросаКоллизии = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	ТекстЗапросаНепринятыеПоДате = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	Если ИспользуетсяВерсионирование Тогда
		Коллизии.ТекстЗапроса = ТекстЗапросаКоллизии;
		Коллизии.ПроизвольныйЗапрос = Истина;
		Коллизии.ОсновнаяТаблица = "РегистрСведений.ВерсииОбъектов";
		Коллизии.ДинамическоеСчитываниеДанных = Истина;
	КонецЕсли;
		
	Если ИспользуетсяВерсионирование И ИспользуетсяДатыЗапретаИзменения Тогда
		НепринятыеПоДате.ТекстЗапроса = ТекстЗапросаНепринятыеПоДате;
		НепринятыеПоДате.ПроизвольныйЗапрос = Истина;
		НепринятыеПоДате.ОсновнаяТаблица = "РегистрСведений.ВерсииОбъектов";
		НепринятыеПоДате.ДинамическоеСчитываниеДанных = Истина;
	КонецЕсли;
