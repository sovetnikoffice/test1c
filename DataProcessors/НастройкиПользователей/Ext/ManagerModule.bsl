...
Процедура ЗаполнитьСписокНастроекВнешнегоВида(Форма)
	...
	ПредставлениеНастройки = НСтр("ru='Рабочий стол и командный интерфейс'");
	РабочийСтолИКомандныйИнтерфейс = НастройкиВнешнегоВида.Строки.Найти(ПредставлениеНастройки, "Настройка");
