...
Процедура ВключениеТехнологическогоЖурнала(ПараметрыТехнологическогоЖурнала, РезультатВключения) Экспорт
	...
	Если КаталогКонфигурацииПриложения <> Неопределено Тогда 
		...
		Исключение
			...
			РезультатВключения.Причина = НСтр("ru = 'Ошибка создания конфигурационного файла в каталоге'")
				+ " " + КаталогКонфигурацииПриложения + Символы.ПС + НСтр("ru = 'Проверьте права доступа.'");
		КонецПопытки;
