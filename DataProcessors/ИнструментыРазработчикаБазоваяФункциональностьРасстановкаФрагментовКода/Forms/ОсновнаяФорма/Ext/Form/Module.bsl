...
Функция ИзменитьТекстыМодулей(ВыборПользователя, Сценарий)
	...
	СтандартныеПодсистемыКлиентСервер.ВывестиПредупреждение(Сценарий, ТекстПредупреждения);
...
Функция ПоказатьРучныеДействия(ВыборПользователя, Сценарий)
	СтандартныеПодсистемыКлиент.ПоказатьРезультатВыполнения(ЭтотОбъект, Сценарий);
	Возврат Истина; // Продолжить сценарий.
КонецФункции
