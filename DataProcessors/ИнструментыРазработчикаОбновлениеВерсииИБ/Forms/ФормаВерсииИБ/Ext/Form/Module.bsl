...
Процедура ЗаписатьВсеНаСервере()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ОбновлениеИБ",
		"ИмитироватьОшибкуПриОбновлении", ИмитироватьОшибкуПриОбновлении, ИмяПользователя());
	
	Если ИмитироватьОшибкуПриОтложенномОбновлении Тогда
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ОтложенноеОбновлениеИБ",
			"ИмитироватьОшибку", ИмитироватьОшибкуПриОтложенномОбновлении);
	КонецЕсли;
